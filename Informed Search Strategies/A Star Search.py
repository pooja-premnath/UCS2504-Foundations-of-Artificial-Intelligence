...
heuristic={('A', 'B'): 4, ('A', 'C'): 4, ('A', 'D'): 4, ('B', 'E'): 6, ('C', 'F'): 3, ('C', 'G'): 2, ('D', 'G'): 1, ('E', 'H'): 9, ('F', 'H'): 2, ('G', 'H'): 1}
...
while current_state!=goal_state:
    ...
    if len(current_neighbors)==1:
        ...
        min_neighbor= current_neighbors[0]
        min_neighbor_cost=node_weight[current_neighbors[0]] + heuristic[(current_state, min_neighbor)]
    

    
        for i in current_neighbors:
        
            i_cost=node_weight[i]+ heuristic[(current_state,i)]
